...
class AppointmentController {
  ...
  async store(req, res) {
    ...
    /**
     * If everything is ok go to store
     */
    ...
    /**
     * Notify provider new appointment
     */
  ...
  async delete(req, res) {
    ...
    const dateBefore = subHours(appointment.date, 2);

    if (isBefore(dateBefore, new Date()))
      return res.status(401).json({
        error: 'You reached the limit of 2 hours to cancel',
      });
